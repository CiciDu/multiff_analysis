...
from neural_data_analysis.topic_based_neural_analysis.stop_event_analysis.get_stop_events import collect_stop_data
...
def main():
    ...
    new_seg_info, events_with_stats = decode_vis.prepare_new_seg_info(pn.ff_dataframe, pn.bin_width)

    binned_spikes, binned_feats, offset_log, meta_used, meta_groups = prepare_stop_design.build_stop_design(new_seg_info, events_with_stats, 
