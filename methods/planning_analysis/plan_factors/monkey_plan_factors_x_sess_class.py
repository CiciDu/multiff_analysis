...
class PlanAcrossSessions(plot_variations_class.PlotVariations):
    ...
    def __init__(self, 
        ...
        self.combd_planning_info_folder_path = make_variations_utils.make_combd_planning_info_folder_path(self.monkey_name)
    ...
    def get_plan_x_and_plan_y_across_sessions(self, 
        ...
        if exists_ok :
            if exists(combd_plan_x_tc_path) & exists(combd_plan_y_tc_path):
                ...
                print('Retrieving combd_plan_y_tc and combd_plan_x_tc failed. Will recreate them.')
    ...
    def _add_new_plan_data_to_combd_data(self, data_name):
        ...
        self.combd_plan_y_tc = pd.concat([self.combd_plan_y_tc, self.pf.plan_y_tc], axis=0)
        self.combd_plan_x_tc = pd.concat([self.combd_plan_x_tc, self.pf.plan_x_tc], axis=0)
