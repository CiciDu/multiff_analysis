...
class _PlotStopsNearFF(find_stops_near_ff_class._FindStopsNearFF):
    ...
    def plot_stops_near_ff_in_plotly_func(self,
        ...
        if self.monkey_plot_params['show_stops']:
            ...
            show_stop_point_indices = trajectory_df[trajectory_df['monkey_speeddummy']
        ...
        if self.monkey_plot_params['show_monkey_heading']:
            plot_monkey_heading_helper_class.PlotMonkeyHeadingHelper.get_all_triangle_df_for_the_point_from_triangle_df_for_all_counted_points(
                self, plot_counter_i, self.current_plotly_plot_key_comp['R'])
    ...
    def _produce_fig_for_dash(self, mark_reference_point=True):
        ...
        if self.monkey_plot_params['show_stops']:
            self.show_stop_point_indices = [int(self.stops_near_ff_row.stop_point_index), int(
                self.stops_near_ff_row.next_stop_point_index)]
        else:
