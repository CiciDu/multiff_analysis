...
class _FindStopsNearFF(base_processing_class.BaseProcessing):
    ...
    def make_stops_near_ff_df_test(self, shared_stops_near_ff_df_already_made_ok=True, exists_ok=True, save_data=True):
        self._make_stops_near_ff_df_test_or_ctrl(
        ...
        if self.shared_stops_near_ff_df is None:
            if exists_ok:
                try:
                    ...
                    self.shared_stops_near_ff_df = find_stops_near_ff_utils.process_shared_stops_near_ff_df(
            ...
            self.shared_stops_near_ff_df, self.all_nxt_ff_df = find_stops_near_ff_utils.make_shared_stops_near_ff_df(self.monkey_information, self.ff_dataframe_visible, self.closest_stop_to_capture_df, self.ff_real_position_sorted,
    ...
    def _add_curv_of_traj_stat_df(self, curv_of_traj_mode='distance', window_for_curv_of_traj=[-25, 25]):
        ...
        self.curv_of_traj_stat_df, self.shared_stops_near_ff_df = plan_factors_utils.find_curv_of_traj_stat_df(
