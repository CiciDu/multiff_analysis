...
def make_diff_and_ratio_stat_df(test_df, ctrl_df):
    ...
    test_stat = test_df[['diff_in_d_heading', 'ratio', 'diff_in_abs_d_heading',
                         'diff_in_abs_d_curv']].describe()
    test_stat.columns = ['test_' + col for col in test_stat.columns]

    ctrl_stat = ctrl_df[['diff_in_d_heading', 'ratio', 'diff_in_abs_d_heading',
                        'diff_in_abs_d_curv']].describe()
    ...
    # diff_stat = pd.concat([test_df['diff_in_d_heading'].describe(), ctrl_df['diff_in_d_heading'].describe()], axis=1)
    # diff_stat.columns = ['test_diff_in_d_heading', 'ctrl_diff_in_d_heading']
    # diff_in_abs_stat = pd.concat([test_df['diff_in_abs_d_heading'].describe(), ctrl_df['diff_in_abs_d_heading'].describe()], axis=1)
    # diff_in_abs_stat.columns = ['test_diff_in_abs_d_heading', 'ctrl_diff_in_abs_d_heading']
