...
class _FindCurVsNxtFF(base_processing_class.BaseProcessing):
    ...
    def _make_shared_stops_near_ff_df_if_not_already_made(self, remove_cases_where_monkey_too_close_to_edge=False,
        ...
        self.shared_stops_near_ff_df, self.all_nxt_ff_df = find_cvn_utils.make_shared_stops_near_ff_df(self.monkey_information, self.ff_dataframe_visible, self.closest_stop_to_capture_df, self.ff_real_position_sorted,
