...
class GUATHelperClass(cluster_replacement_class.ClusterReplacement):
    ...
    def process_current_and_alternative_ff_info(self,
        ...
        self.GUAT_current_ff_info[['whether_changed',
                                   'whether_intended_target']] = False
        self.GUAT_alt_ff_info[['whether_changed',
                               'whether_intended_target']] = False
        ...
        self.GUAT_alt_ff_info['order'] = self.GUAT_alt_ff_info['order'] + \
            num_old_ff_per_row
    ...
    def find_input_and_output(self,
        ...
        if add_arc_info:
            curvature_utils.add_arc_info_to_df(
                self.GUAT_joined_ff_info, curvature_df, arc_info_to_add=arc_info_to_add)
