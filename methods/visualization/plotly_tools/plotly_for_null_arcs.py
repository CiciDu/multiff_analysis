...
def find_best_arc_df_for_ff_in_duration(ff_indices, duration, curv_of_traj_df, monkey_information, ff_real_position_sorted, optimal_arc_stop_at_visible_boundary=True):
    mini_ff_dataframe = make_mini_ff_dataframe(ff_indices, duration, monkey_information, ff_real_position_sorted, ff_radius=10, max_distance=400)
    ...
    ff_best_arc_df, best_arc_original_columns = find_best_arc.make_best_arc_df(temp_curvature_df, monkey_information, ff_real_position_sorted)
...
def make_mini_ff_dataframe(ff_indices, duration, monkey_information, ff_real_position_sorted, ff_radius=10, max_distance=400):
    ...
    for i in ff_indices:
        ...
        monkey_angle = monkey_angle + cum_angle[ff_within_range_indices].tolist()
        ff_distance = ff_distance + distances_to_ff[ff_within_range_indices].tolist()
        ff_angle = ff_angle + angles_to_ff[ff_within_range_indices].tolist()
        ff_angle_boundary = ff_angle_boundary + angles_to_boundaries[ff_within_range_indices].tolist()
