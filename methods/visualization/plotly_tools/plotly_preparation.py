...
def _make_trajectory_df(PlotTrials_args,
    ...
    if rotation_matrix is None:
        rotation_matrix = plot_behaviors_utils.find_rotation_matrix(cum_mx, cum_my)
...
def _make_connect_path_ff_df(row,
    ...
    connect_path_ff_df = _rotate_positions_in_connect_path_ff_df(connect_path_ff_df, rotation_matrix)
...
def _rotate_positions_in_connect_path_ff_df(connect_path_ff_df, rotation_matrix):
    ...
    ff_positions_rotated = np.matmul(rotation_matrix, connect_path_ff_df[['ff_x', 'ff_y']].T.values)
    connect_path_ff_df[['ff_x', 'ff_y']] = ff_positions_rotated.T

    # Rotate monkey positions
    monkey_positions_rotated = np.matmul(rotation_matrix, connect_path_ff_df[['monkey_x', 'monkey_y']].T.values)
