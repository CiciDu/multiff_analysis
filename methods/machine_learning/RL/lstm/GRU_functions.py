...
class QNetworkGRU(LSTM_functions.QNetworkBase):
    def __init__(self, state_space, action_space, hidden_dim, activation=F.relu, output_activation=None):
        ...
        self.linear4.apply(LSTM_functions.linear_weights_init)
...
class SAC_PolicyNetworkGRU(LSTM_functions.PolicyNetworkBase):
