...
class TargetDecoderSegmentAlignedClass(target_decoder_class.TargetDecoderClass, gpfa_helper_class.GPFAHelperClass):
    ...
    def get_rebinned_behav_data(self, use_lagged_behav_data_for_gpfa=False,
        ...
        self.use_lagged_behav_data_for_gpfa = use_lagged_behav_data_for_gpfa
        self.use_reduced_behav_data_for_gpfa = use_reduced_behav_data_for_gpfa

        if use_lagged_behav_data_for_gpfa:
        ...
        self.rebinned_behav_data['new_bin'] = (
            self.rebinned_behav_data.groupby('segment').cumcount())
    ...
    def get_raw_spikes_for_regression(self):
        ...
        # drop all columns in x_var_df that do not start with 'unit_'
        x_var_df = x_var_df[[
            col for col in x_var_df.columns if col.startswith('unit_')]]
