...
probably will need to make heading_info_df and stuff afresh...while either not saving them or only in rsw_vs_rcap
Rather than test or control, we'll want rsw or  rcap

'''


class DashForRswAndRcap(miss_events_class.MissEventsClass, dash_main_class.DashMainPlots):
    ...
    def streamline_organizing_info_2(self, **kwargs):
        ...
        self.remove_i_o_modify_rows_with_big_ff_angles = kwargs[
            'remove_i_o_modify_rows_with_big_ff_angles']
        self.curv_traj_window_before_stop = kwargs.get(
        ...
        self.add_info_to_nxt_ff_and_cur_ff_df(
