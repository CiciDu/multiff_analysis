    ...
    for sample in range(num_samples):
        ...
        for trial in range(num_trials_per_sample):
            ...
            while len(ff_to_be_considered) < 3:
                ...
                ff_to_be_considered = np.where(
                    manhattan_distance < threshold)[0]
            ...
            min_arc_length, min_arc_radius, min_arc_ff_xy, min_arc_ff_distance, min_arc_ff_angle, \
                min_arc_ff_angle_boundary = show_null_trajectory.find_shortest_arc_among_all_available_ff(
                    ff_x=ffxy[ff_to_be_considered, 0], ff_y=ffxy[ff_to_be_considered, 1], monkey_x=0, monkey_y=0, monkey_angle=pi/2)
            ...
            ff_angle_boundary_of_min_time_trial.append(
                min_arc_ff_angle_boundary)
        ...
        ff_angle_boundary_of_min_time_trial = np.array(
            ff_angle_boundary_of_min_time_trial)
        ...
        all_median_abs_angle_boundary.append(
        ...
        all_mean_abs_angle_boundary.append(
