...
class GLMPipeline:
    ...
    def load_or_prune_columns(self, X, cols_path, skip_vif=False, pruned_columns_exists_ok: bool = True):
        ...
        """
        X_out, vif_report = design_checks.load_or_compute_selected_cols(X, cols_path, skip_vif=skip_vif, exists_ok=pruned_columns_exists_ok)
    ...
    def fit_glm(self, name, df_X, *, use_groups: bool, glm_results_exists_ok: bool = True):
        ...
        report = general_glm_fit.glm_mini_report(
            ...
            save_dir=os.path.join(self.output_root, 'glm_fit', subfolder_name),
    ...
    def run(self, 
        ...
        """
        self.run_behavior_only(glm_results_exists_ok=glm_results_exists_ok, pruned_columns_exists_ok=pruned_columns_exists_ok)
        self.run_behavior_plus_history(glm_results_exists_ok=glm_results_exists_ok, pruned_columns_exists_ok=pruned_columns_exists_ok)
        self.run_history_only(glm_results_exists_ok=glm_results_exists_ok, pruned_columns_exists_ok=pruned_columns_exists_ok)
