...
# 'abs_nxt_ff_rel_x',
    ...
    stimulus_basis_dict: Dict[str, object] = {
        ...
        "cur_ff_rel_x": [B_short, B_spline_short],
        "nxt_ff_rel_x": [B_short, B_spline_short],
        "cur_ff_rel_y": [B_short, B_spline_short],
        "nxt_ff_rel_y": [B_short, B_spline_short],
        "cur_ff_angle": [B_short, B_spline_short],
        "nxt_ff_angle": [B_short, B_spline_short],
        "cur_ff_distance": [B_short, B_spline_short],
        "nxt_ff_distance": [B_short, B_spline_short],
        "cur_ff_angle_sin": [B_short, B_spline_short],
        "cur_ff_angle_cos": [B_short, B_spline_short],
        "nxt_ff_angle_sin": [B_short, B_spline_short],
        "nxt_ff_angle_cos": [B_short, B_spline_short],
