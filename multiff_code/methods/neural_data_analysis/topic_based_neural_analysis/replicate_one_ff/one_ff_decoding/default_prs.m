function prs = default_prs(monk_id,session_id)
    ...
    prs.filepath_behv = ['C:\Users\jkl9\Documents\Data\one_ff\' monkeyInfo.folder '\behavioural data\'];
    prs.filepath_neur = ['C:\Users\jkl9\Documents\Data\one_ff\' monkeyInfo.folder '\neural data\'];
    ...
    %% population analysis
    prs.canoncorr_varname = {'v','w','r_targ','theta_targ','d','phi','dv','dw','eye_ver','eye_hor'}; % list of variables to include in the task variable matrix
