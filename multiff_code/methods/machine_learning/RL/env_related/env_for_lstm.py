...
class EnvForLSTM(base_env.MultiFF):
    ...
    def __init__(self, episode_len=1024, distance2center_cost=2, add_ff_time_since_start_visible=True, **kwargs):
        ...
        super().__init__(episode_len=episode_len, max_in_memory_time=0,
    ...
    def _get_ff_array_for_belief(self):
        self._get_ff_array_for_belief_common(
            self.visible_ff_indices, add_memory=False, add_ff_time_since_start_visible=self.add_ff_time_since_start_visible)
