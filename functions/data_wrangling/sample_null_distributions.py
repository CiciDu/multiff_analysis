...
def sample_null_distributions_func(print_progress = True, num_samples = 1000, num_trials_per_sample = 1000):
    ...
    for sample in range(num_samples):
        ...
        for trial in range(num_trials_per_sample):
            ...
            num_ff = 200
            arena_radius = 1000
            fftheta = random.rand(num_ff) * 2 * pi
            ...
            min_arc_length, min_arc_radius, min_arc_ff_xy, min_arc_ff_distance, min_arc_ff_angle, \
                    min_arc_ff_angle_boundary = plot_behaviors.find_shortest_arc(ff_x=ffxy[ff_to_be_considered, 0], ff_y=ffxy[ff_to_be_considered, 1], monkey_x=0, monkey_y=0, monkey_angle=pi/2)
